...
--nearest neighbour pixel filter
...
gTextures = {
    ...
    ['tile_depressed'] = love.graphics.newImage('graphics/tile_depressed.png'),
...
gFonts = {
    ...
    ['start'] = love.graphics.newFont('fonts/PressStart2P.ttf', 16),
    ['start-small'] = love.graphics.newFont('fonts/PressStart2P.ttf', 8)
}